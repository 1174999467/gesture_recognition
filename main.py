...
def binaryMask(frame, x0, y0, width, height):
    # 显示方框
    cv2.rectangle(frame, (x0, y0), (x0+width, y0+height), (0, 255, 0))   # 未知涵义
    #提取ROI像素
...
while(True):
    ...
    if key == ord('s'):
        ...
        path ="G:\\PyCharmProject\\gesture_recognition" + "\\" + gesturename + "\\" # 生成文件夹的地址  用来存放录制的手势
